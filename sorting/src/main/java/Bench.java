...
public class Bench {
    ...
    public static Function<int[], int[]> selectionSort = array -> {
        Lab1.selectionSort(array);
        return array;
    };
    ...
    public static Function<int[], int[]> quickSort = array -> {
        Lab1.quickSort(array);
        return array;
    };

    public static Function<int[], int[]> mergeSort = Lab1::mergeSort;
            ...
            while (true) {
                ...
                if (runtime >= target) {
                    ...
                    if (runtime == 0)
                        ...
                        repetitions *= (double) 2 * target / runtime;
